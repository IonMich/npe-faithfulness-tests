...
| Sign-symmetry stress, folded target | $`(|\theta_1|,\theta_2)`$ | `-1.42694 +/- 0.00115` |
...
Posterior-shape checks from earlier sign experiments remain in the run folder,
but the project-level sign status is now the full-prior population NLL result
above.
